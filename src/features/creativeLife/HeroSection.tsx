export default function HeroSection() {
  return (
    <section className="py-stack-lg lg:py-section-gap-lg w-full max-w-7xl px-8 lg:px-4">
      <div className="gap-stack-md flex flex-col items-center lg:flex-row-reverse lg:items-center lg:justify-between">
        <div className="gap-stack-lg flex flex-col">
          ...
          <p className="font-body-lg text-body-xl max-w-lg text-balance text-stone-600 italic lg:max-w-2xl">
