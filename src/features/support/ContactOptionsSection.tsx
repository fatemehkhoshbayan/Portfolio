export default function ContactOptionsSection() {
  return (
    <section className="bg-brand-soft/20 py-stack-2xl w-full max-w-7xl rounded-3xl px-10 text-center lg:px-4">
      <h2 className="font-headline-lg text-headline-lg text-primary mb-4">
        Prefer a direct conversation?
      </h2>
      <p className="font-body-lg text-body-lg text-support mb-stack-lg mx-auto max-w-xl">
        Whether you have a project in mind or just want to chat, my door is always open.
      </p>
